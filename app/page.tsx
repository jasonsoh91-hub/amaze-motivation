                  ...
                  <form onSubmit={handleSubmit} className="w-full">
                    <div className="space-y-3">
                      ...
                      <button
                        ...
                        className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 disabled:from-amber-400 disabled:via-yellow-400 disabled:to-amber-400 text-white font-bold px-6 py-4 rounded-full text-base transition-all duration-300 transform hover:scale-105 disabled:opacity-80 disabled:hover:scale-100 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg min-h-[44px] mt-2"
                      >
                        {isSubmitting ? (
                          <>
