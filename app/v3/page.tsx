...
function OptInFormSection() {
  ...
  return (
    <section ref={ref} className="py-16 relative overflow-hidden" style={{ background: "#FEF9F3" }}>
        ...
        >
          {isSuccess ? (
            <div className="text-center py-8">
              ...
              <h3 className="text-2xl font-bold mb-2" style={{ color: "#1A1A2E" }}>You're in!</h3>
              <p style={{ color: "#6B7280" }}>Check your email for the free guide.</p>
            </div>
          ) : (
